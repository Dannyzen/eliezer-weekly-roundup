...
Bad skills are long transcripts, motivational prose, stale checklists, or untested instructions that silently override newer project facts.
...
The pattern is implementable immediately with markdown files, retrieval, typed schemas, and regression tests. The remaining hard work is lifecycle management: review, versioning, applicability scoring, and deprecation.
